...
local function v115()
	...
	if ((v70 >= (728 - (483 + 200))) and v27(v7) and (v24.Cleanse:CooldownDown() or not v24.ImprovedCleanse:IsAvailable()) and v7:IsInRange(1503 - (1404 + 59))) then
	...
	if ((v70 >= (95 - 60)) and v29() and (v7:HealthPercentage() > (0 - 0)) and (v7:HealthPercentage() < (865 - (468 + 297)))) then
		if v24.HolyShock:IsReady() then
			v16(v24.HolyShock);
			return;
		end
	...
	if not v107 then
		if (v24.LoH:IsReady() and v6:AffectingCombat()) then
			...
			if (v65 ~= nil) then
				if (v65:DebuffDown(v24.ForbearanceDebuff) and (v65:HealthPercentage() <= v38.SpecialHealing.LoHHP) and (v65:HealthPercentage() > (0 - 0))) then
					if (v66 == nil) then
						v66 = v23();
						v67 = math.random(43 + 107, 1036 - (141 + 95)) / (983 + 17);
		...
		if ((v24.BoV:CooldownRemains() >= (18.5 - 10)) or (v79 > (1 + 0)) or not v24.BoV:IsAvailable()) then
			if (v24.HolyPrism:IsReady() and (v70 > (123 - 78)) and v7:IsInRange(29 + 11) and v6:AffectingCombat() and v7:AffectingCombat() and v18.TargetIsValid() and v18.AoELogicWithCount(v38.AoE2.HPHP, v38.AoE2.HPCount, v38.Cooldowns.HPUsage, v36)) then
				v16(v24.HolyPrism);
				return "Holy Prism on Target per Settings";
			end
			if (v24.HolyPrism:IsReady() and (v70 <= (24 + 21)) and v18.AoELogicWithCount(v38.AoE2.HPHP, v38.AoE2.HPCount, v38.Cooldowns.HPUsage, v36)) then
		...
		if v6:AffectingCombat() then
			...
			if v24.HolyBulwark:IsReady() then
				...
				if ((v38.Healing.HBTank and (v70 <= (188 - (92 + 71))) and (v70 <= v38.Healing.HBHP)) or (not v38.Healing.HBTank and (v70 <= v38.Healing.HBHP))) then
					v68:Cast(v24.HolyBulwark);
					return "Holy Bulwark";
				end
			end
		end
		if (v24.HandofDivintiy:IsReady() and not v6:IsMoving() and v38.TyrSettings.BeforeTyrs and v18.AoELogicWithCount(v38.AoE.TyrsHP, v38.AoE.TyrsCount, "With Logic", v36) and ((not v6:IsInRaid() and v6:IsInParty() and (v70 >= (30 + 30))) or v6:IsInRaid())) then
		...
		if (v24.HandofDivintiy:IsReady() and not v6:IsMoving() and (v70 <= v38.SpecialHealing.HandofDivinityHP) and (v70 >= (810 - (574 + 191))) and not v6:IsMoving()) then
			v16(v24.HandofDivintiy);
			return "Hand of Divinity Normal";
		end
		if ((v24.BoV:CooldownRemains() >= (7.5 + 1)) or (v79 > (2 - 1)) or not v24.BoV:IsAvailable()) then
			if (v68 ~= nil) then
		...
		if (v6:BuffUp(v24.DivineFavorBuff) and v24.HolyLight:IsReady() and not v6:PrevGCD(850 - (254 + 595), v24.HolyLight) and not v6:IsCasting() and (((v111 <= v38.SpecialHealing.HLBoth) and v6:BuffUp(v24.Infusion)) or (v111 <= v38.SpecialHealing.HLDFHP)) and not v6:IsMoving()) then
			v68:Cast(v24.HolyLight);
			return "Holy Light for Divine Favor";
		end
		if (v69 ~= nil) then
			if (not v24.HolyShock:IsReady() and (not v6:IsInRaid() or (v6:IsInRaid() and (v6:HolyPower() > (130 - (55 + 71)))))) then
		...
		if ((v111 >= (85 - 20)) and v6:AffectingCombat() and v24.BlessingofSummer:IsAvailable()) then
		...
		if (v6:BuffUp(v24.TyrsDeliverancePlayerBuff) and v24.BoundlessSalvation:IsAvailable()) then
			if (v72 ~= nil) then
				if (v24.HolyLight:IsReady() and v6:BuffUp(v24.HandofDivintiy) and ((v72:HealthPercentage() <= v38.TyrSettings.TyrHLHP) or (v6:BuffRemains(v24.HandofDivintiy) <= (1796 - (573 + 1217))))) then
					v72:Cast(v24.HolyLight);
					return "Holy Light on Tyr's Target";
				end
				if (v24.HolyShock:IsReady() and (((v6:HolyPower() < (13 - 8)) and v6:BuffDown(v24.RisingSunlight)) or ((v6:HolyPower() < (1 + 2)) and v6:BuffUp(v24.RisingSunlight)))) then
		...
		if (v6:BuffDown(v24.TyrsDeliverancePlayerBuff) or not v24.BoundlessSalvation:IsAvailable()) then
			if (v24.HolyLight:IsReady() and v6:BuffUp(v24.HandofDivintiy) and ((v70 <= v38.SpecialHealing.HandofDivinityHP) or (v6:BuffRemains(v24.HandofDivintiy) <= (9 - 3)))) then
				v68:Cast(v24.HolyLight);
				return "Holy Light with HoD";
			end
		end
		if v6:BuffUp(v24.AvengingCrusader) then
			if (v79 >= (940 - (714 + 225))) then
				if (v108:IsReady() and v75 and ((v70 <= v38.Healing.WoGHP) or v76)) then
					v68:Cast(v108);
					return "WoG on BoV Unit During AC";
				end
			end
			if (v24.Judgment:IsReady() and v7:IsInRange(87 - 57) and (v70 <= (125 - 35)) and v18.TargetIsValid()) then
				v16(v24.Judgment);
			...
			if (v24.CrusaderStrike:IsReady() and v99 and (v70 <= (10 + 80)) and v18.TargetIsValid()) then
			...
			if (v24.HammerofWrath:IsReady() and v7:IsInRange(43 - 13) and v18.TargetIsValid()) then
				v16(v24.HammerofWrath);
				return "Hammer of Wrath During AC";
			end
		end
		if v24.VenerationTalent:IsAvailable() then
			if (((v24.EternalFlame:IsAvailable() and not v75) or not v24.EternalFlame:IsAvailable()) and v24.HammerofWrath:IsReady() and v7:IsInRange(836 - (118 + 688)) and v18.TargetIsValid()) then
				v13.Cast(v24.HammerofWrath);
				return "Hammer of Wrath Veneration";
			end
		end
		if (v18.TargetIsValid() and v7:AffectingCombat() and v24.Judgment:IsReady() and v7:IsInRange(78 - (25 + 23)) and ((v70 <= (18 + 72)) or (v6:BuffUp(v24.AwakeningMaxBuff) and v18.AoELogicWithCount(1961 - (927 + 959), 10 - 7, "With Logic", v36)) or (v6:BuffUp(v24.AwakeningMaxBuff) and (v6:BuffRemains(v24.AwakeningMaxBuff) < (735 - (16 + 716)))))) then
		...
		if v24.HolyShock:IsReady() then
			...
			v88 = ((v6:HolyPower() < (290 - (175 + 110))) and v6:BuffDown(v24.RisingSunlight)) or ((v6:HolyPower() < (9 - 5)) and v6:BuffUp(v24.RisingSunlight)) or v38.Holy.Overcap;
		...
		if (v18.TargetIsValid() and v7:AffectingCombat()) then
			if (v24.HammerofWrath:IsReady() and v7:IsInRange(147 - 117)) then
				v13.Cast(v24.HammerofWrath);
				return "Hammer of Wrath";
			end
			if (v24.Judgment:IsReady() and v7:IsInRange(1826 - (503 + 1293)) and ((v70 <= (251 - 161)) or v6:BuffUp(v24.AwakeningMaxBuff))) then
				v13.Cast(v24.Judgment);
				return "Judgement";
			end
	...
	if (v18.TargetIsValid() and ((v70 >= (1106 - (810 + 251))) or v107) and not v26(v7) and (v7:AffectingCombat() or (v38.Holy.AttackOOC and v89))) then
		if (v24.Consecration:IsReady() and v7:IsInRange(6 + 2) and not v6:IsMoving() and (v40(v24.Consecration) <= (0 + 0))) then
			v16(v24.Consecration);
			return "consecration priority 20";
		end
		if (v24.ShieldoftheRighteous:IsUsable() and v99 and (v6:HolyPower() >= (3 + 0)) and ((v6:BuffUp(v24.AvengingWrathBuff) and (v111 >= (588 - (43 + 490)))) or v110 or v107)) then
			v13.Cast(v24.ShieldoftheRighteous);
			return "shield_of_the_righteous priority 2";
		end
		if (v24.HammerofWrath:IsReady() and v7:IsInRange(763 - (711 + 22)) and ((v6:HolyPower() < (19 - 14)) or v38.Holy.Overcap or v107)) then
			v16(v24.HammerofWrath);
			return "hammer_of_wrath priority 4";
		end
		if (v24.DivineToll:IsReady() and v107 and v38.Holy.UseDTDPS and v7:IsInRange(899 - (240 + 619))) then
			v16(v24.DivineToll);
			return "Divine Toll for DPS Only";
		end
		if (v24.HammerofWrath:IsReady() and v7:IsInRange(8 + 22) and ((v6:HolyPower() < (7 - 2)) or v38.Holy.Overcap or v107)) then
			v16(v24.HammerofWrath);
			return "hammer_of_wrath priority 14";
		end
		if (v24.Judgment:IsReady() and v7:IsInRange(2 + 28) and ((v6:HolyPower() < (1749 - (1344 + 400))) or v38.Holy.Overcap or v107)) then
			v16(v24.Judgment);
			return "judgment priority 16";
		end
		if (v24.HolyShock:IsReady() and v7:IsInRange(445 - (255 + 150)) and ((v38.Holy.UseHolyShockDPS and ((v6:HolyPower() < (4 + 1)) or v38.Holy.Overcap)) or v107)) then
			v16(v24.HolyShock);
			return "holy_shock priority 22";
		end
		if (v24.CrusaderStrike:IsReady() and v99 and ((v6:HolyPower() < (3 + 2)) or v38.Holy.Overcap or v107)) then
			v16(v24.CrusaderStrike);
			return "crusader_strike priority 24";
		end
		if (v24.HolyPrism:IsReady() and ((v34 >= (8 - 6)) or v107)) then
...
local function v116()
	...
	if (not v6:IsMounted() and (v18.TargetIsValid() or v6:AffectingCombat() or v89)) then
		if v90 then
			...
			if (v24.Rebuke:CooldownDown() or not v24.Rebuke:IsAvailable()) then
				if (v24.BlindingLight:IsReady() and v38.Holy.UseBL) then
					v35 = v18.InterruptCycle(v24.BlindingLight, 416 - (183 + 223), false, nil, true, true);
					if v35 then
						return v35;
					end
				end
				if v24.HammerofJustice:IsReady() then
					v35 = v18.InterruptCycle(v24.HammerofJustice, 12 - 2, false, nil, true);
					if v35 then
						return v35;
					end
				end
		...
		if (v6:IsInRaid() and v24.BlessingofFreedom:IsReady()) then
			if (v6:DebuffUp(v11(281265 + 143230), true) or v6:DebuffUp(v11(152767 + 271730), true)) then
				v6:Cast(v24.BlessingofFreedom);
				return;
			end
		end
		if (v24.Repentance:IsReady() and not v6:IsInRaid() and v6:AffectingCombat()) then
			v35 = v18.IncorpCycle(v24.Repentance, 367 - (10 + 327), false, false);
			if v35 then
				return v35;
			end
		end
		if (v24.TurnEvil:IsReady() and not v6:IsInRaid() and (not v24.Repentance:IsAvailable() or v24.Repentance:CooldownDown())) then
			v35 = v18.IncorpCycle(v24.TurnEvil, 28 + 12, false, false);
			if v35 then
				return v35;
			end
		end
		if (v38.Holy.AutoTabMelee and (v33 > (338 - (118 + 220))) and not v99 and v6:CanAttack(v7)) then
			v13.TopPanelAlternative:ChangeIcon(1 + 0, 452 - (108 + 341));
...
local function v117()
	...
	v13.ToggleIconFrame:AddButtonCustom("D", 8 - 6, "Dispel", "dispel");
	v13.ToggleIconFrame:AddButtonCustom("K", 1496 - (711 + 782), "Kick", "kick");
	v13.ToggleIconFrame:AddButtonCustom("L", 7 - 3, "Light of Dawn", "lightofdawn");
	v13.ToggleIconFrame:AddButtonCustom("DP", 474 - (270 + 199), "DPS Only", "dpsonly");
	v13.ToggleIconFrame:AddButtonCustom("S", 2 + 4, "Shield of the Righteous", "shieldoftherighteous");
	v13.Print("Holy Paladin rotation has been updated for Pre-Patch");
end
v13.SetAPL(1884 - (580 + 1239), v116, v117, v114);
