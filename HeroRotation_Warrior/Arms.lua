...
local function v65()
	...
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(2 + 6)) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes colossus_st 20";
		end
	end
	if (v18.Overpower:IsCastable() and v48 and (v18.Overpower:Charges() == (3 - 1))) then
		if v11(v18.Overpower) then
			return "overpower colossus_st 22";
		end
	end
...
local function v66()
	if (v18.SweepingStrikes:IsCastable() and (v50 == (793 - (368 + 423)))) then
	...
	if (v18.ThunderousRoar:IsCastable() and v7:IsInMeleeRange(37 - 25) and IsThunderousRoar) then
		if v11(v18.ThunderousRoar, true) then
	...
	if (v18.Warbreaker:IsCastable() and v7:IsInRange(26 - (10 + 8)) and IsColossusSmash) then
		if v11(v18.Warbreaker, true) then
	...
	if (v18.MortalStrike:IsReady() and v48 and (v7:DebuffStack(v18.ExecutionersPrecisionDebuff) == (7 - 5)) and v7:DebuffDown(v18.RavagerDebuff) and ((v6:BuffStack(v18.LethalBlowsBuff) == (444 - (416 + 26))) or not v6:HasTier("TWW1", 12 - 8))) then
		if v11(v18.MortalStrike) then
			return "mortal_strike colossus_execute 20";
		end
	end
	if (v18.Execute:IsReady() and v48 and (v6:Rage() >= (18 + 22))) then
		if v11(v18.Executecast) then
			return "execute colossus_execute 22";
		end
	end
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(13 - 5)) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes colossus_execute 24";
		end
	end
	if (v18.Overpower:IsCastable() and v48) then
		if v11(v18.Overpower) then
	...
	if (v18.MortalStrike:IsReady() and v48) then
		if v11(v18.MortalStrike) then
			return "mortal_strike colossus_execute 32";
		end
	end
end
local function v67()
	if (v18.SweepingStrikes:IsCastable() and v7:IsInMeleeRange(446 - (145 + 293))) then
		if v11(v18.SweepingStrikes) then
			return "sweeping_strikes colossus_sweep 2";
		end
	end
	if (v18.Rend:IsCastable() and (v7:DebuffRemains(v18.RendDebuff) <= v6:GCD()) and v6:BuffUp(v18.SweepingStrikesBuff)) then
		if v11(v18.Rend, nil, nil, not v48) then
	...
	if (v18.Overpower:IsCastable() and v48 and (((v18.Overpower:Charges() == (1 + 1)) and v18.Dreadnaught:IsAvailable()) or v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Overpower) then
			return "overpower colossus_sweep 18";
		end
	end
	...
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(7 + 1) and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes colossus_sweep 22";
		end
	end
	if (v18.Demolish:IsCastable() and IsDemolish and not v6:IsMoving() and v48 and v6:BuffUp(v18.SweepingStrikesBuff) and v7:DebuffUp(v18.ColossusSmashDebuff)) then
		if v11(v18.Demolish) then
			return "demolish colossus_sweep 24";
		end
	end
	if (v18.MortalStrike:IsReady() and v48 and (v6:BuffDown(v18.SweepingStrikesBuff))) then
		if v11(v18.MortalStrike) then
			return "mortal_strike colossus_sweep 26";
		end
	end
	if (v18.Demolish:IsCastable() and IsDemolish and not v6:IsMoving() and v48 and (v6:BuffUp(v18.AvatarBuff) or (v7:DebuffUp(v18.ColossusSmashDebuff) and (v18.AVatar:CooldownRemains() >= (807 - (201 + 571)))))) then
		if v11(v18.Demolish) then
			return "demolish colossus_sweep 28";
		end
	end
	if (v18.Execute:IsReady() and v48 and ((v18.WarlordsTorment:IsAvailable() and (v18.Avatar:TimeSinceLastCast() < (1144 - (116 + 1022)))) or v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Executecast) then
			return "execute colossus_sweep 30";
		end
	end
	if (v18.Overpower:IsCastable() and v48 and ((v18.Overpower:Charges() == (8 - 6)) or v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Overpower) then
			return "overpower colossus_sweep 32";
		end
	end
	if (v18.Execute:IsReady() and v48) then
		if v11(v18.Executecast) then
	...
	if (v18.ThunderClap:IsReady() and v48 and (v7:DebuffRemains(v18.RendDebuff) < (5 + 3)) and v6:BuffDown(v18.SweepingStrikesBuff)) then
		if v11(v18.ThunderClap) then
			return "thunder_clap colossus_sweep 36";
		end
	end
	if (v18.Rend:IsCastable() and v48 and (v7:DebuffRemains(v18.RendDebuff) <= (18 - 13))) then
		if v11(v18.Rend) then
...
local function v68()
	if (v18.Cleave:IsReady() and v48 and v6:BuffUp(v18.CollateralDamageBuff) and v6:BuffUp(v18.MercilessBonegrinderBuff)) then
		if v11(v18.Cleave) then
	...
	if (v18.Ravager:IsCastable() and v48 and IsBladestorm) then
		if v10.CastTarget(v18.Ravager, v10.TName().PLAYER) then
			return "ravager colossus_aoe 10";
		end
	end
	if (v18.SweepingStrikes:IsCastable() and v7:IsInMeleeRange(867 - (814 + 45))) then
		if v11(v18.SweepingStrikes) then
			return "sweeping_strikes colossus_aoe 12";
		end
	end
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(19 - 11) and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes colossus_aoe 14";
		end
	end
	if (v18.Warbreaker:IsCastable() and v7:IsInRange(1 + 7) and IsColossusSmash) then
		if v11(v18.Warbreaker, true) then
	...
	if (v18.Bladestorm:IsCastable() and v48 and IsBladestorm and (v18.Unhinged:IsAvailable() or v18.MercilessBonegrinder:IsAvailable())) then
		if v11(v18.Bladestormcast, true) then
			return "bladestorm colossus_aoe 18";
		end
	end
	if (v18.ChampionsSpear:IsCastable() and v48 and IsChampionsSpear) then
		if v10.CastTarget(v18.ChampionsSpear, v10.TName().PLAYER) then
	...
	if (v18.Demolish:IsCastable() and IsDemolish and not v6:IsMoving() and v48 and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Demolish) then
			return "demolish colossus_aoe 26";
		end
	end
	if (v18.Bladestorm:IsCastable() and v48 and IsBladestorm and (v18.Unhinged:IsAvailable())) then
		if v11(v18.Bladestormcast, true) then
	...
	if (v18.Overpower:IsCastable() and v48 and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Overpower) then
			return "overpower colossus_aoe 34";
		end
	end
	if (v18.Execute:IsReady() and v48 and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Executecast) then
			return "execute colossus_aoe 36";
		end
	end
	...
	if (v18.MortalStrike:IsReady() and v48) then
		if v11(v18.MortalStrike) then
			return "mortal_strike colossus_aoe 40";
		end
	end
	if (v18.Execute:IsReady() and v48) then
		if v11(v18.Executecast) then
...
local function v69()
	...
	if (v18.Warbreaker:IsCastable() and v7:IsInRange(13 - 5) and IsColossusSmash) then
		if v11(v18.Warbreaker, true) then
			return "warbreaker slayer_st 12";
		end
	end
	if (v18.Execute:IsReady() and v48 and ((v7:DebuffStack(v18.MarkedforExecutionDebuff) == (1083 - (1020 + 60))) or (v6:BuffRemains(v18.JuggernautBuff) <= (v6:GCD() * (1426 - (630 + 793)))) or (v6:BuffStack(v18.SuddenDeathBuff) == (6 - 4)))) then
		if v11(v18.Executecast) then
			return "execute slayer_st 14";
		end
	end
	if (v18.Bladestorm:IsCastable() and v48 and IsBladestorm and ((v18.ColossusSmash:CooldownRemains() >= (v6:GCD() * (18 - 14))) or (v6:BuffRemains(v18.ColossusSmashDebuff) >= (v6:GCD() * (2 + 2))))) then
		if v11(v18.Bladestormcast, true) then
	...
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(27 - 19)) then
		if v11(v18.Skullsplitter) then
	...
	if (v18.Rend:IsCastable() and v48 and (v7:DebuffRemains(v18.RendDebuff) <= (v6:GCD() * (1752 - (760 + 987))))) then
		if v11(v18.Rend) then
			return "rend slayer_st 28";
		end
	end
	if (v18.Cleave:IsReady() and v48 and (v6:BuffDown(v18.MartialProwessBuff))) then
		if v11(v18.Cleave) then
			return "cleave slayer_st 30";
		end
	end
	if (v18.Slam:IsReady() and v48) then
		if v11(v18.Slam) then
			return "slam slayer_st 32";
		end
	end
	if (v18.StormBolt:IsCastable() and v7:IsInRange(1933 - (1789 + 124)) and (v6:BuffUp(v18.Bladestorm))) then
		if v11(v18.StormBolt) then
			return "storm_bolt slayer_st 34";
		end
	end
end
local function v70()
	if (v18.SweepingStrikes:IsCastable() and (v50 == (768 - (745 + 21)))) then
		if v11(v18.SweepingStrikes) then
			return "sweeping_strikes slayer_execute 2";
		end
	end
	if (v18.Rend:IsCastable() and v48 and (v7:DebuffRemains(v18.RendDebuff) <= v6:GCD()) and not v18.Bloodletting:IsAvailable()) then
		if v11(v18.Rend) then
			return "rend slayer_execute 4";
		end
	end
	if (v18.ThunderousRoar:IsCastable() and v7:IsInMeleeRange(5 + 7) and IsThunderousRoar) then
		if v11(v18.ThunderousRoar, true) then
	...
	if (v18.Avatar:IsCastable() and v48 and IsAvatar and ((v18.ColossusSmash:CooldownRemains() <= (13 - 8)) or v7:DebuffUp(v18.ColossusSmashDebuff))) then
		if v11(v18.Avatar, true) then
	...
	if (v18.Execute:IsReady() and v48 and (v6:BuffRemains(v18.JuggernautBuff) <= v6:GCD())) then
		if v11(v18.Executecast) then
			return "execute slayer_execute 16";
		end
	end
	if (v18.Bladestorm:IsCastable() and v48 and IsBladestorm and (((v7:DebuffStack(v18.ExecutionersPrecisionDebuff) == (1 + 1)) and (v7:DebuffRemains(v18.ColossusSmashDebuff) > (4 + 0))) or ((v7:DebuffStack(v18.ExecutionersPrecisionDebuff) == (1057 - (87 + 968))) and (v18.ColossusSmash:CooldownRemains() > (66 - 51))) or not v18.ExecutionersPrecision:IsAvailable())) then
		if v11(v18.Bladestormcast, true) then
			return "bladestorm slayer_execute 18";
		end
	end
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(8 + 0) and (v6:Rage() < (192 - 107))) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes slayer_execute 20";
		end
	end
	if (v18.MortalStrike:IsReady() and v48 and ((v7:DebuffRemains(v18.RendDebuff) < (1415 - (447 + 966))) or ((v7:DebuffStack(v18.ExecutionersPrecisionDebuff) == (5 - 3)) and (v6:BuffStack(v18.LethalBlowsBuff) == (1819 - (1703 + 114)))))) then
		if v11(v18.MortalStrike) then
			return "mortal_strike slayer_execute 22";
		end
	end
	if (v18.Overpower:IsCastable() and v48 and v6:BuffUp(v18.OpportunistBuff) and (v6:Rage() < (781 - (376 + 325))) and (v6:BuffStack(v18.MartialProwessBuff) < (2 - 0))) then
		if v11(v18.Overpower) then
	...
	if (v18.Execute:IsReady() and v48) then
		if v11(v18.Executecast) then
			return "execute slayer_execute 26";
		end
	end
	if (v18.Overpower:IsCastable() and v48) then
		if v11(v18.Overpower) then
	...
	if (v18.MortalStrike:IsReady() and v48 and not v18.ExecutionersPrecision:IsAvailable()) then
		if v11(v18.MortalStrike) then
			return "mortal_strike slayer_execute 30";
		end
	end
	if (v18.StormBolt:IsCastable() and v7:IsInRange(61 - 41) and (v6:BuffUp(v18.Bladestorm))) then
		if v11(v18.StormBolt) then
			return "storm_bolt slayer_execute 32";
		end
	end
end
local function v71()
	...
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(22 - (9 + 5)) and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes slayer_sweep 16";
		end
	end
	if (v18.Execute:IsReady() and v48 and (v7:DebuffStack(v18.MarkedforExecutionDebuff) == (379 - (85 + 291)))) then
		if v11(v18.Executecast) then
	...
	if (v18.Overpower:IsCastable() and v48 and (v18.Dreadnaught:IsAvailable() or v6:BuffUp(v18.OpportunistBuff))) then
		if v11(v18.Overpower) then
	...
	if (v18.Cleave:IsReady() and v48 and (v18.FervorofBattle:IsAvailable())) then
		if v11(v18.Cleave) then
			return "cleave slayer_sweep 26";
		end
	end
	if (v18.Execute:IsReady() and v48) then
		if v11(v18.Executecast) then
			return "execute slayer_sweep 28";
		end
	end
	if (v18.Overpower:IsCastable() and v48) then
		if v11(v18.Overpower) then
	...
	if (v18.ThunderClap:IsReady() and v48 and (v7:DebuffRemains(v18.RendDebuff) < (1273 - (243 + 1022))) and v6:BuffDown(v18.SweepingStrikesBuff)) then
		if v11(v18.ThunderClap) then
			return "thunder_clap slayer_sweep 32";
		end
	end
	if (v18.Rend:IsCastable() and v48 and (v7:DebuffRemains(v18.RendDebuff) <= (19 - 14))) then
		if v11(v18.Rend) then
...
local function v72()
	if (v18.ThunderClap:IsReady() and v48 and (v7:DebuffDown(v18.RendDebuff))) then
		if v11(v18.ThunderClap) then
			return "thunder_clap slayer_aoe 2";
		end
	end
	if (v18.SweepingStrikes:IsCastable() and v48) then
		if v11(v18.SweepingStrikes) then
			return "sweeping_strikes slayer_aoe 4";
		end
	end
	if (v18.ThunderousRoar:IsCastable() and v7:IsInMeleeRange(1192 - (1123 + 57)) and IsThunderousRoar) then
		if v11(v18.ThunderousRoar, true) then
	...
	if (v18.Warbreaker:IsCastable() and v7:IsInRange(7 + 1) and IsColossusSmash) then
		if v11(v18.Warbreaker, true) then
	...
	if (v18.ColossusSmash:IsCastable() and v48 and IsColossusSmash) then
		if v11(v18.ColossusSmash, true) then
			return "colossus_smash slayer_aoe 14";
		end
	end
	if (v18.Cleave:IsReady() and v48) then
		if v11(v18.Cleave) then
			return "cleave slayer_aoe 16";
		end
	end
	if (v18.Overpower:IsCastable() and v48 and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Overpower) then
	...
	if (v18.Execute:IsReady() and v48 and v6:BuffUp(v18.SuddenDeathBuff) and (v6:BuffStack(v18.ImminentDemiseBuff) < (257 - (163 + 91)))) then
		if v11(v18.Executecast) then
	...
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(1938 - (1869 + 61)) and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes slayer_aoe 24";
		end
	end
	if (v18.Execute:IsReady() and v48 and v6:BuffUp(v18.SweepingStrikesBuff) and (v7:DebuffStack(v18.ExecutionersPrecisionDebuff) < (1 + 1))) then
		if v11(v18.Executecast) then
			return "execute slayer_aoe 26";
		end
	end
	if (v18.MortalStrike:IsReady() and v48 and v6:BuffUp(v18.SweepingStrikesBuff) and (v7:DebuffStack(v18.ExecutionersPrecisionDebuff) == (6 - 4))) then
		if v11(v18.MortalStrike) then
			return "mortal_strike slayer_aoe 28";
		end
	end
	if (v18.Execute:IsReady() and v48 and (v7:DebuffUp(v18.MarkedforExecutionDebuff))) then
		if v11(v18.Executecast) then
			return "execute slayer_aoe 30";
		end
	end
	if (v18.MortalStrike:IsReady() and v48 and (v6:BuffUp(v18.SweepingStrikesBuff))) then
		if v11(v18.MortalStrike) then
			return "mortal_strike slayer_aoe 32";
		end
	end
	if (v18.Overpower:IsCastable() and v48 and (v18.Dreadnaught:IsAvailable())) then
		if v11(v18.Overpower) then
			return "overpower slayer_aoe 34";
		end
	end
	if (v18.ThunderClap:IsReady() and v48) then
		if v11(v18.ThunderClap) then
			return "thunder_clap slayer_aoe 36";
		end
	end
	if (v18.Overpower:IsCastable() and v48) then
		if v11(v18.Overpower) then
			return "overpower slayer_aoe 38";
		end
	end
	if (v18.Execute:IsReady() and v48) then
		if v11(v18.Executecast) then
	...
	if (v18.MortalStrike:IsReady() and v48) then
		if v11(v18.MortalStrike) then
			return "mortal_strike slayer_aoe 42";
		end
	end
	if (v18.Whirlwind:IsReady() and v48) then
		if v11(v18.Whirlwind) then
			return "whirlwind slayer_aoe 44";
		end
	end
	if (v18.Skullsplitter:IsCastable() and v7:IsInMeleeRange(12 - 4)) then
		if v11(v18.Skullsplitter) then
			return "sweeping_strikes slayer_aoe 46";
		end
	end
	if (v18.Slam:IsReady() and v48) then
		if v11(v18.Slam) then
			return "slam slayer_aoe 48";
		end
	end
	if (v18.StormBolt:IsCastable() and v7:IsInRange(3 + 17) and (v6:BuffUp(v18.Bladestorm))) then
		if v11(v18.StormBolt) then
			return "storm_bolt slayer_aoe 50";
		end
	end
end
local function v73()
...
local function v75()
	...
	if (v21.TargetIsValid() or v6:AffectingCombat()) then
		v48 = v7:IsSpellInRange(v18.Slam);
	...
	if v21.TargetIsValid() then
		if (not v23.Arms.AttackonlyinCombat or (v23.Arms.AttackonlyinCombat and v7:AffectingCombat())) then
			if not v57(v5.Target) then
				...
				if (v18.Berserking:IsCastable() and IsRacials and (((v7:TimeToDie() > (2170 - (582 + 1408))) and v6:BuffUp(v18.AvatarBuff)) or ((v7:TimeToDie() < (624 - 444)) and (((v7:HealthPercentage() < (44 - 9)) and v18.Massacre:IsAvailable()) or (v7:HealthPercentage() < (75 - 55))) and v6:BuffUp(v18.AvatarBuff)) or (v7:TimeToDie() < (1844 - (1195 + 629))))) then
				...
				if (v18.Demolish:IsAvailable() and v12() and (v50 == (243 - (187 + 54))) and not v47) then
					local v107 = v67();
					if v107 then
						return v107;
					end
				...
				if ((v18.SlayersDominance:IsAvailable() or Lowlevel) and v12() and (v50 > (782 - (162 + 618)))) then
					local v109 = v72();
					if v109 then
						return v109;
					end
...
local function v76()
	...
	v10.ToggleIconFrame:AddButtonCustom("A", 3 - 1, "Auto Stance", "autostance");
	v10.ToggleIconFrame:AddButtonCustom("I", 4 - 1, "Interrupt", "interrupt");
	v10.Print("Arms Warrior rotation has been updated for patch 11.0.2. Last Update 28.09.2024");
end
v10.SetAPL(6 + 65, v75, v76);
