...
local function v71()
	local v98, v99 = v6:GetTrinketData(v24);
	if ((v69 < (5 + 0)) and ((v98.ID == (0 - 0)) or (v99.ID == (1065 - (68 + 997))) or (v98.Level == (1270 - (226 + 1044))) or (v99.Level == (0 - 0)) or ((v98.SpellID > (117 - (32 + 85))) and not v98.Usable) or ((v99.SpellID > (0 + 0)) and not v99.Usable))) then
		v69 = v69 + 1 + 0;
	...
	local v116 = v17(v50:HasUseBuff() and (v52 ~= v23.OvinaxsMercurialEgg:ID()));
	local v117 = v17(v51:HasUseBuff() and (v53 ~= v23.OvinaxsMercurialEgg:ID())) * (4 - 2);
	v68 = (0 - 0) + v116 + v117;
end
v71();
...
local function v72(v118)
	...
	elseif (v118 == v22.Moonfire) then
		v119 = 10 - 4;
		if v22.MoonGuardian:IsAvailable() then
			v119 = v119 + 2 + 0;
		end
	elseif (v118 == v22.Sunfire) then
		v119 = 797 - (368 + 423);
	elseif (v118 == v22.NewMoon) then
		v119 = 31 - 21;
	elseif (v118 == v22.HalfMoon) then
		v119 = 38 - (10 + 8);
	elseif (v118 == v22.FullMoon) then
		v119 = 153 - 113;
	elseif (v118 == v22.ForceofNature) then
		v119 = 462 - (416 + 26);
	end
	return v119;
end
local function v73(v120)
	return v120:DebuffRefreshable(v22.MoonfireDebuff) and ((v120:TimeToDie() - v120:DebuffRemains(v22.MoonfireDebuff)) > (19 - 13)) and (not v22.TreantsoftheMoon:IsAvailable() or ((v46 - v22.MoonfireDebuff:AuraActiveCount()) > (3 + 3)) or ((v22.ForceofNature:CooldownRemains() > (4 - 1)) and v6:BuffDown(v22.HarmonyoftheGroveBuff)));
end
local function v74(v121)
	return (v121:DebuffRemains(v22.MoonfireDebuff) < (441 - (145 + 293))) and (not v22.TreantsoftheMoon:IsAvailable() or ((v22.ForceofNature:CooldownRemains() > (433 - (44 + 386))) and v6:BuffDown(v22.HarmonyoftheGroveBuff)));
end
local function v75(v122)
	return v122:DebuffRefreshable(v22.MoonfireDebuff) and (not v22.TreantsoftheMoon:IsAvailable() or ((v22.ForceofNature:CooldownRemains() > (1489 - (998 + 488))) and v6:BuffDown(v22.HarmonyoftheGroveBuff)));
end
local function v76(v123)
	return v123:DebuffRefreshable(v22.StellarFlareDebuff) and ((v123:TimeToDie() - v123:DebuffRemains(v22.StellarFlareDebuff)) > (3 + 4 + v46));
end
local function v77(v124)
	return v124:DebuffRefreshable(v22.StellarFlareDebuff) and ((v124:TimeToDie() - v124:DebuffRemains(v22.StellarFlareDebuff)) > (6 + 1 + v46));
end
local function v78(v125)
	return v125:DebuffRefreshable(v22.SunfireDebuff) and ((v125:TimeToDie() - v125:DebuffRemains(v22.SunfireDebuff)) > ((778 - (201 + 571)) - (v46 / (1140 - (116 + 1022)))));
end
local function v79(v126)
	return (v126:DebuffRemains(v22.SunfireDebuff) < (12 - 9)) or v126:DebuffRefreshable(v22.SunfireDebuff);
end
local function v80(v127)
	return v127:DebuffRefreshable(v22.SunfireDebuff);
end
local function v81(v128)
	return v128:NPCID() == (120072 + 84488);
end
local function v82(v129)
	return v129:CastSpellID() == (1492420 - 1083615);
end
local function v83()
...
local function v86(v130, v131)
	return (v130:gsub("{(.-)}", v131));
end
local v87;
local function v88(v132)
	return (v132 ~= "Not Used") and ((((v132 == "with Cooldowns") or ((v132 == "small CDs") and v28.Balance_CDUSE.smallcdswithCooldowns) or (v132 == "with Cooldowns or AoE") or (v132 == "on Enemycount or Cooldowns") or (v132 == "on Boss or with Cooldowns")) and v15()) or (v132 == "always") or (((v132 == "on Boss only") or (v132 == "on Boss or on Enemycount") or (v132 == "on Boss or with Cooldowns")) and (v87 or v8:IsDummy())) or ((v132 == "with Bloodlust only") and v6:BloodlustUp()) or ((v132 == "small CDs") and Smallcds) or (((v132 == "on AOE") or (v132 == "with Cooldowns or AoE")) and (v46 >= (3 - 1))) or (((v132 == "on Enemycount or Cooldowns") or (v132 == "on Enemycount") or (v132 == "on Boss or on Enemycount")) and (v46 >= v28.Balance_CDUSE.Enemycount)));
end
local function v89(v133)
	return (v87 and v28.Balance_TTD.IgnoreWhenBoss) or v25.Buggedmobs[v8:NPCID()] or (v25.ISSolo() and v28.Balance_TTD.IgnoreWhenSolo) or (v133 == (1080 - (1020 + 60))) or ((v48 >= v133) and (v48 < (9200 - (630 + 793))));
end
local function v90()
...
local function v94()
	...
	if (v22.Moonfire:IsCastable() and v135) then
	...
	if (v22.Moonfire:IsCastable() and not v135) then
		if v25.CastCycle(v22.Moonfire, v45, v73, v44) then
...
local function v95()
	if Baerform then
		...
		if v6:BuffUp(v22.BearForm) then
			if (v22.ThrashBear:IsCastable() and v8:IsInRange(10 - 5) and v8:DebuffRefreshable(v22.ThrashBearDebuff)) then
				if v16(v22.Thrashcast) then
					return "thrash bear";
				end
			end
			if (v22.Mangle:IsCastable() and v8:IsInRange(7 - 2) and (v8:DebuffUp(v22.ThrashBearDebuff) or not v22.ThrashBear:IsAvailable())) then
				if v16(v22.Mangle) then
					return "Mangle bear";
				end
			end
			if (v22.Swipe:IsCastable() and v8:IsInRange(14 - 9)) then
...
local function v96()
	...
	InterruptToggle = v13.ToggleIconFrame:GetToggle(397 - (115 + 281));
	DispelToggle = v13.ToggleIconFrame:GetToggle(4 - 2);
	Smallcds = v13.ToggleIconFrame:GetToggle(3 + 0);
	UseSpender = v13.ToggleIconFrame:GetToggle(9 - 5);
	Baerform = v13.ToggleIconFrame:GetToggle(18 - 13);
	local v137 = not v6:AffectingCombat() or not v8:AffectingCombat() or v8:IsDummy();
	Enemies40Yard = v6:GetEnemiesInRange(907 - (550 + 317));
	EnemiesRangeOOCCount = v84() or #Enemies40Yard;
	v49 = v25.UnitsinRange(v22.Regrowth);
	v45 = v8:GetEnemiesInSplashRange(14 - 4);
	if v14() then
	...
	if not v6:IsMoving() then
		v19 = not v6:IsCasting(v22.Hibernate) and v25.IncorpCycle(v22.Hibernate, 66 - 31, false, false);
		if v19 then
			return v19;
		end
	end
	if DispelToggle then
		v19 = v6:AffectingCombat() and v25.SootheCycle(v22.Soothe, 2035 - (582 + 1408), false, v28.Balance.TabForSoothe);
		if v19 then
			return v19;
		end
		if v22.RemoveCorruption:IsCastable() then
			...
			if not v81(v5.Target) then
				if TargetinRange then
					...
					if (InterruptToggle and not v85()) then
						v19 = v25.InterruptCycle(v22.SolarBeam, 138 - 98, true, nil, false);
						if v19 then
							return v19;
						end
						v19 = v25.InterruptCycle(v22.MightyBash, 9 - 1, false, nil, true);
						if v19 then
							return v19;
						end
					end
					v29 = ((22 - 16) / v6:SpellHaste()) + v17(v22.NaturesBalance:IsAvailable()) + (v17(v22.OrbitBreaker:IsAvailable()) * v17(v22.MoonfireDebuff:AuraActiveCount() > (1824 - (1195 + 629))) * v17(v26.OrbitBreakerStacks > ((35 - 8) - ((243 - (187 + 54)) * v17(v6:BuffUp(v22.SolsticeBuff))))) * (804 - (162 + 618)));
					v30 = v20(v40:CooldownRemains(), v22.ForceofNature:CooldownRemains());
					v31 = ((v47 < ((11 + 4 + ((4 + 1) * v17(v22.Incarnation:IsAvailable()))) * ((1 - 0) - (v17(v22.WhirlingStars:IsAvailable()) * (0.2 - 0))))) or ((v8:TimeToDie() > (1 + 9)) and ((v6:HeroTreeID() ~= (1659 - (1373 + 263))) or v6:BuffUp(v22.HarmonyoftheGroveBuff)) and (not v22.WhirlingStars:IsAvailable() or not v22.ConvoketheSpirits:IsAvailable() or (v22.ConvoketheSpirits:CooldownRemains() < (v6:GCD() * (1002 - (451 + 549)))) or (v47 < (v22.ConvoketheSpirits:CooldownRemains() + 1 + 2)) or (v22.ConvoketheSpirits:CooldownRemains() > v40:FullRechargeTime())))) and v40:CooldownUp() and not v38;
					v37 = (v47 < (7 - 2)) or ((v38 or (v40:CooldownRemains() > (67 - 27))) and ((v6:HeroTreeID() ~= (1407 - (746 + 638))) or v6:BuffUp(v22.HarmonyoftheGroveBuff) or (v22.ForceofNature:CooldownRemains() > (6 + 9))));
					...
					v35 = v22.LunarCalling:IsAvailable() or (v46 > ((2 - 0) - v17((v22.UmbralIntensity:TalentRank() + v17(v22.SouloftheForest:IsAvailable())) > (342 - (218 + 123)))));
					...
					if v28.Commons.Enabled.Trinkets then
						...
						if (v23.SpymastersWeb:IsEquippedAndReady() and (((v50:ID() == v23.SpymastersWeb:ID()) and IsTrinket1) or ((v51:ID() == v23.SpymastersWeb:ID()) and IsTrinket2)) and ((v31 and ((v6:BuffStack(v22.SpymastersReportBuff) > (1610 - (1535 + 46))) or (v47 < v41))) or (v47 < (20 + 0)))) then
							if v16(v23.SpymastersWeb, true) then
								return "spymasters_web main 4";
							end
						end
						if (v23.ImperfectAscendancySerum:IsEquippedAndReady() and (((v50:ID() == v23.ImperfectAscendancySerum:ID()) and IsTrinket1) or ((v51:ID() == v23.ImperfectAscendancySerum:ID()) and IsTrinket2)) and (v8:DebuffRemains(v22.SunfireDebuff) > (1 + 3)) and ((v8:DebuffRemains(v22.MoonfireDebuff) > (564 - (306 + 254))) or (v22.TreantsoftheMoon:IsAvailable() and ((v22.ForceofNature:CooldownRemains() < (1 + 2)) or v6:BuffUp(v22.HarmonyoftheGroveBuff)) and (v30 < (1 - 0))) or (v47 < (1487 - (899 + 568))) or ((v47 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp()))) and (v6:BuffStack(v22.SpymastersReportBuff) <= (20 + 9))) then
							if v16(v23.ImperfectAscendancySerum, true) then
								return "imperfect_ascendancy_serum main 6";
							end
						end
						if (v23.TreacherousTransmitter:IsEquippedAndReady() and (((v50:ID() == v23.TreacherousTransmitter:ID()) and IsTrinket1) or ((v51:ID() == v23.TreacherousTransmitter:ID()) and IsTrinket2)) and ((v30 < (7 - 4)) or (v47 < (623 - (268 + 335))) or ((v47 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp()))) and (v6:BuffStack(v22.SpymastersReportBuff) <= (319 - (60 + 230)))) then
							if v16(v23.TreacherousTransmitter, true) then
								return "treacherous_transmitter main 8";
							end
						end
					end
					VarGenericTrinketCondition = v32 or ((v47 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp())) or ((((v6:BuffStack(v22.SpymastersReportBuff) + (v30 / (578 - (426 + 146)))) > (4 + 25)) or (v47 < (v41 + v30))) and (v30 > (1476 - (282 + 1174)))) or (v68 == (811 - (569 + 242)));
					if v28.Commons.Enabled.Trinkets then
						if (v50:IsReady() and v8:IsInRange(v58) and IsTrinket1 and not v60 and not v66 and (((v68 ~= (2 - 1)) and (v51:CooldownRemains() > (2 + 18))) or (((v68 == (1025 - (706 + 318))) or (v68 == (1254 - (721 + 530)))) and v31) or (v47 < ((1291 - (945 + 326)) + ((49 - 29) * v17(v51:CooldownRemains() < (23 + 2))))) or VarGenericTrinketCondition)) then
							if v16(v50, true) then
								return "use_items trinket1 (" .. v50:Name() .. ") main 10";
							end
						end
						if (v51:IsReady() and v8:IsInRange(v59) and IsTrinket2 and not v61 and not v67 and (((v68 ~= (702 - (271 + 429))) and (v50:CooldownRemains() > (19 + 1))) or ((v68 == (1502 - (1408 + 92))) and v31) or (v47 < ((1106 - (461 + 625)) + ((1308 - (993 + 295)) * v17(v50:CooldownRemains() < (2 + 23))))) or VarGenericTrinketCondition)) then
							if v16(v51, true) then
								return "use_items trinket2 (" .. v51:Name() .. ") main 12";
							end
						end
					end
					if (v28.Commons.Enabled.Potions and (v38 or (v47 <= (1201 - (418 + 753))))) then
						local v147 = v25.PotionSelected();
						if (v147 and v147:IsReady() and IsPotions) then
							v13.CastMacro(2 + 1, nil, nil, v147);
					...
					if v6:BuffUp(v22.BearForm) then
						...
						if (v22.Mangle:IsCastable() and v8:IsInRange(2 + 3) and (v8:DebuffUp(v22.ThrashBearDebuff) or not v22.ThrashBear:IsAvailable())) then
							if v16(v22.Mangle) then
								return "Mangle bear";
							end
						end
						if (v22.Swipe:IsCastable() and v8:IsInRange(2 + 3)) then
							if v16(v22.Swipecast) then
								return "Swipe bear";
							end
						end
						if (v22.ThrashBear:IsCastable() and v8:IsInRange(534 - (406 + 123))) then
							if v16(v22.Thrashcast) then
								return "thrash bear";
							end
						end
					...
					if Baerform then
						...
						if (v22.Berserking:IsCastable() and IsRacials and (v31 or v32 or (v47 < (1784 - (1749 + 20))))) then
							if v16(v22.Berserking, true) then
						...
						v33 = v6:BuffUp(v22.EclipseLunar) or v6:BuffUp(v22.EclipseSolar);
						v34 = v20(v6:BuffRemains(v22.EclipseLunar), v6:BuffRemains(v22.EclipseSolar));
						v35 = v22.LunarCalling:IsAvailable() or (v46 > ((1 + 1) - v17((v22.UmbralIntensity:TalentRank() + v17(v22.SouloftheForest:IsAvailable())) > (1323 - (1249 + 73)))));
						v36 = v6:BuffStack(v22.BOATArcaneBuff) + v6:BuffStack(v22.BOATNatureBuff);
						if (v22.WarriorofElune:IsCastable() and IsWarriorofElune and (v22.LunarCalling:IsAvailable() or ((v34 >= (3 + 4)) and (v40:CooldownRemains() > (1165 - (466 + 679)))))) then
							if v16(v22.WarriorofElune, true) then
...
local function v97()
	...
	v13:UpdateMacro("macro1", v86(v139, v138));
	v13:UpdateMacro("macro2", "/use 16");
	v13:UpdateMacro("macro6", "/stopcasting");
	v13.ToggleIconFrame:AddButtonCustom("I", 2 - 1, "Interrupt", "interrupt");
	v13.ToggleIconFrame:AddButtonCustom("D", 1902 - (106 + 1794), "Dispel", "dispel");
	...
	v13.ToggleIconFrame:AddButtonCustom("B", 14 - 9, "BaerForm", "bearform");
	v25.PostInitialMessage(276 - 174);
end
v13.SetAPL(216 - (4 + 110), v96, v97);
