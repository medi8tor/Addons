...
local function v90()
	...
	if (v28.Commons.Enabled.Items and v23.BestinSlotsCaster:IsEquippedAndReady() and (((v6:HeroTreeID() == (1936 - (1789 + 124))) and v6:BuffUp(v22.HarmonyoftheGroveBuff)) or ((v6:HeroTreeID() == (790 - (745 + 21))) and ((CaInc:FullRechargeTime() > (7 + 13)) or v39)))) then
		v13.CastMacro(2 - 1, nil, nil, v23.BestinSlotsCaster);
		return "use_items trinket2 (" .. v50:Name() .. ") pre_cd 10";
	end
end
local function v91()
	if (v22.WarriorofElune:IsCastable() and IsWarriorofElune and (v22.LunarCalling:IsAvailable() or (not v22.LunarCalling:IsAvailable() and (v35 <= (27 - 20))))) then
	...
	if (v22.Moonfire:IsCastable() and (not v22.ForceofNature:IsAvailable() or (v22.ForceofNature:CooldownRemains() > (1 + 4)) or not IsForceofNature or not v22.TreantsoftheMoon:IsAvailable())) then
	...
	if (v22.ForceofNature:IsCastable() and IsForceofNature and (((v41:CooldownRemains() < v6:GCD()) and (not v22.ConvoketheSpirits:IsAvailable() or (v22.ConvoketheSpirits:CooldownRemains() < (v6:GCD() * (3 + 0))) or (v22.ConvoketheSpirits:CooldownRemains() > v41:FullRechargeTime()) or (v47 < (v22.ConvoketheSpirits:CooldownRemains() + (1058 - (87 + 968)))))) or (((v41:FullRechargeTime() + (22 - 17) + ((14 + 1) * v17(v22.ControloftheDream:IsAvailable()))) > (135 - 75)) and (not v22.ConvoketheSpirits:IsAvailable() or ((v22.ConvoketheSpirits:CooldownRemains() + (1423 - (447 + 966)) + ((41 - 26) * v17(v22.ControloftheDream:IsAvailable()))) > (1877 - (1703 + 114))) or (v47 < (v22.ConvoketheSpirits:CooldownRemains() + ConvokeCD + (706 - (376 + 325))))) and ((v47 > (106 - 41)) or (v47 < (v41:CooldownRemains() + (21 - 14))))) or (v22.WhirlingStars:IsAvailable() and v22.ConvoketheSpirits:IsAvailable() and (v22.ConvoketheSpirits:CooldownRemains() > (15 + 35)) and (v47 > (v22.ConvoketheSpirits:CooldownRemains() + (12 - 6)))))) then
		if v16(v22.ForceofNature, true) then
			return "force_of_nature st 22";
		end
	end
	if (v22.FuryofElune:IsCastable() and IsFuryofElune and (((19 - (9 + 5)) + v29) < v6:AstralPowerDeficit())) then
	...
	if (v22.Starsurge:IsReady() and UseSpender and v22.Starlord:IsAvailable() and (v6:BuffStack(v22.StarlordBuff) < (379 - (85 + 291)))) then
		if v16(v22.Starsurge) then
	...
	if (v22.Starsurge:IsReady() and UseSpender and (v22.ConvoketheSpirits:CooldownRemains() < (v6:GCD() * (1267 - (243 + 1022)))) and v38) then
		if v16(v22.Starsurge) then
	...
	if (v22.Starsurge:IsReady() and UseSpender and (((v6:BuffRemains(v22.StarlordBuff) > (14 - 10)) and (v37 >= (3 + 0))) or (v46 < (1184 - (1123 + 57))))) then
		if v16(v22.Starsurge) then
			return "starsurge st 26";
		end
	end
	if (v22.NewMoon:IsCastable() and not v6:IsMoving() and ((v6:AstralPowerDeficit() > (v29 + v70(v22.NewMoon))) or (v46 < (17 + 3)) or (v41:CooldownRemains() > (269 - (163 + 91))))) then
		if v16(v22.NewMoon) then
			return "new_moon st 28";
		end
	end
	if (v22.HalfMoon:IsCastable() and not v6:IsMoving() and (((v6:AstralPowerDeficit() > (v29 + v70(v22.HalfMoon))) and ((v6:BuffRemains(v22.EclipseLunar) > v22.HalfMoon:ExecuteTime()) or (v6:BuffRemains(v22.EclipseSolar) > v22.HalfMoon:ExecuteTime()))) or (v46 < (1950 - (1869 + 61))) or (v41:CooldownRemains() > (5 + 10)))) then
		if v16(v22.HalfMoon) then
			return "half_moon st 30";
		end
	end
	if (v22.FullMoon:IsCastable() and not v6:IsMoving() and (((v6:AstralPowerDeficit() > (v29 + v70(v22.FullMoon))) and ((v6:BuffRemains(v22.EclipseLunar) > v22.FullMoon:ExecuteTime()) or (v6:BuffRemains(v22.EclipseSolar) > v22.FullMoon:ExecuteTime()))) or (v46 < (70 - 50)) or (v41:CooldownRemains() > (23 - 8)))) then
	...
	if (v22.Starsurge:IsReady() and UseSpender and (v6:AstralPowerDeficit() < (v29 + v70(v22.Wrath) + ((v70(v22.Starfire) + v29) * (v17(v6:BuffRemains(v22.EclipseSolar) < (v6:GCD() * (1 + 2)))))))) then
		if v16(v22.Starsurge) then
			return "starsurge st 38";
		end
	end
	if (v22.ForceofNature:IsCastable() and IsForceofNature and (v6:HeroTreeID() ~= (30 - 7))) then
		if v16(v22.ForceofNature, true) then
			return "force_of_nature st 40";
		end
	end
	if (v22.WildMushroom:IsCastable() and IsWildMushroom and not v6:PrevGCD(1 + 0, v22.WildMushroom) and (v8:DebuffRemains(v22.FungalGrowthDebuff) < (1476 - (1329 + 145)))) then
	...
	if (v6:IsMoving() and v28.Balance.SpamDot) then
		if (v22.Sunfire:IsCastable() and (v45 > (972 - (140 + 831)))) then
...
local function v92()
	...
	if (v22.Starfall:IsReady() and v43 and (v6:AstralPowerDeficit() <= (v29 + (1856 - (1409 + 441))))) then
	...
	if (v22.StellarFlare:IsCastable() and (v45 < ((((729 - (15 + 703)) - v22.UmbralIntensity:TalentRank()) - ((1 + 1) * v17(v22.AstralSmolder:IsAvailable()))) - v17(v22.LunarCalling:IsAvailable())))) then
		if v25.CastCycle(v22.StellarFlare, v44, v74, v43) then
			return "stellar_flare aoe 8";
		end
	end
	if (v22.ForceofNature:IsCastable() and (((v41:CooldownRemains() < v6:GCD()) and (not v34 or (v35 > (444 - (262 + 176))))) or ((v35 >= (1724 - (345 + 1376))) and (v41:CooldownRemains() > ((698 - (198 + 490)) + ((66 - 51) * v17(v22.ControloftheDream:IsAvailable())))) and ((v47 > (155 - 90)) or (v41:CooldownRemains() > v47))))) then
		if v16(v22.ForceofNature, true) then
	...
	if (v22.WarriorofElune:IsCastable() and IsWarriorofElune and ((not v22.LunarCalling:IsAvailable() and (v6:BuffRemains(v22.EclipseSolar) < (1213 - (696 + 510)))) or v22.LunarCalling:IsAvailable())) then
		if v16(v22.WarriorofElune, true) then
	...
	if (v22.ConvoketheSpirits:IsCastable() and IsConvoketheSpirits and ((v6:BuffDown(v22.DreamstateBuff) and v6:BuffDown(v22.UmbralEmbraceBuff) and (v45 < (1269 - (1091 + 171)))) or (v45 == (1 + 0))) and ((v46 < (15 - 10)) or ((v39 or (v41:CooldownRemains() > (132 - 92))) and ((v6:HeroTreeID() ~= (408 - (123 + 251))) or v6:BuffUp(v22.HarmonyoftheGroveBuff) or (v22.ForceofNature:CooldownRemains() > (74 - 59)))))) then
		if v16(v22.ConvoketheSpirits) then
	...
	if (v22.ForceofNature:IsCastable() and IsForceofNature and (v6:HeroTreeID() ~= (721 - (208 + 490)))) then
		if v16(v22.ForceofNature, true) then
...
local function v93()
	...
	InterruptToggle = v13.ToggleIconFrame:GetToggle(837 - (660 + 176));
	DispelToggle = v13.ToggleIconFrame:GetToggle(1 + 1);
	Smallcds = v13.ToggleIconFrame:GetToggle(205 - (14 + 188));
	UseSpender = v13.ToggleIconFrame:GetToggle(679 - (534 + 141));
	local v134 = not v6:AffectingCombat() or not v8:AffectingCombat() or v8:IsDummy();
	Enemies40Yard = v6:GetEnemiesInRange(17 + 23);
	EnemiesRangeOOCCount = v82() or #Enemies40Yard;
	v48 = v25.UnitsinRange(v22.Regrowth);
	v44 = v8:GetEnemiesInSplashRange(9 + 1);
	if v14() then
	...
	if not v6:IsMoving() then
		v19 = not v6:IsCasting(v22.Hibernate) and v25.IncorpCycle(v22.Hibernate, 19 + 16, false, false);
		if v19 then
			return v19;
		end
	end
	if DispelToggle then
		v19 = v6:AffectingCombat() and v25.SootheCycle(v22.Soothe, 29 + 16, false, v28.Balance.TabForSoothe);
		if v19 then
			return v19;
		end
			...
			if not v79(v5.Target) then
				if TargetinRange then
					...
					if (InterruptToggle and not v83()) then
						v19 = v25.InterruptCycle(v22.SolarBeam, 436 - (115 + 281), true, nil, false);
						if v19 then
							return v19;
						end
						v19 = v25.InterruptCycle(v22.MightyBash, 18 - 10, false, nil, true);
						if v19 then
							return v19;
						end
					end
					v29 = ((5 + 1) / v6:SpellHaste()) + v17(v22.NaturesBalance:IsAvailable()) + (v17(v22.OrbitBreaker:IsAvailable()) * v17(v22.MoonfireDebuff:AuraActiveCount() > (0 - 0)) * v17(v26.OrbitBreakerStacks > ((98 - 71) - ((869 - (550 + 317)) * v17(v6:BuffUp(v22.SolsticeBuff))))) * (33 - 9));
					v30 = v20(v41:CooldownRemains(), v22.ForceofNature:CooldownRemains());
					v31 = v46 < (v42 + v30);
					v32 = ((v46 < (((21 - 6) + ((13 - 8) * v17(v22.Incarnation:IsAvailable()))) * ((286 - (134 + 151)) - (v17(v22.WhirlingStars:IsAvailable()) * (1665.2 - (970 + 695)))))) or ((v8:TimeToDie() > (19 - 9)) and ((v6:HeroTreeID() ~= (2013 - (582 + 1408))) or v6:BuffUp(v22.HarmonyoftheGroveBuff)) and (not v22.WhirlingStars:IsAvailable() or not v22.ConvoketheSpirits:IsAvailable() or (v22.ConvoketheSpirits:CooldownRemains() < (v6:GCD() * (6 - 4))) or (v46 < (v22.ConvoketheSpirits:CooldownRemains() + (3 - 0))) or (v22.ConvoketheSpirits:CooldownRemains() > v41:FullRechargeTime())))) and v41:CooldownUp() and not v39;
					v38 = (v46 < (18 - 13)) or ((v39 or (v41:CooldownRemains() > (1864 - (1195 + 629)))) and ((v6:HeroTreeID() ~= (29 - 6)) or v6:BuffUp(v22.HarmonyoftheGroveBuff) or (v22.ForceofNature:CooldownRemains() > (256 - (187 + 54)))));
					...
					v36 = v22.LunarCalling:IsAvailable() or (v45 > ((782 - (162 + 618)) - v17((v22.UmbralIntensity:TalentRank() + v17(v22.SouloftheForest:IsAvailable())) > (1 + 0))));
					...
					if v28.Commons.Enabled.Trinkets then
						...
						if (v23.SpymastersWeb:IsEquippedAndReady() and (((v49:ID() == v23.SpymastersWeb:ID()) and IsTrinket1) or ((v50:ID() == v23.SpymastersWeb:ID()) and IsTrinket2)) and ((v32 and ((v6:BuffStack(v22.SpymastersReportBuff) > (20 + 9)) or (v46 < v42))) or (v46 < (42 - 22)))) then
							if v16(v23.SpymastersWeb, true) then
								return "spymasters_web main 4";
							end
						end
						if (v23.ImperfectAscendancySerum:IsEquippedAndReady() and (((v49:ID() == v23.ImperfectAscendancySerum:ID()) and IsTrinket1) or ((v50:ID() == v23.ImperfectAscendancySerum:ID()) and IsTrinket2)) and (v8:DebuffRemains(v22.SunfireDebuff) > (6 - 2)) and ((v8:DebuffRemains(v22.MoonfireDebuff) > (1 + 3)) or (v22.TreantsoftheMoon:IsAvailable() and ((v22.ForceofNature:CooldownRemains() < (1639 - (1373 + 263))) or v6:BuffUp(v22.HarmonyoftheGroveBuff)) and (v30 < (1001 - (451 + 549)))) or (v46 < (7 + 13)) or ((v46 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp()))) and (v6:BuffStack(v22.SpymastersReportBuff) <= (44 - 15))) then
							if v16(v23.ImperfectAscendancySerum, true) then
								return "imperfect_ascendancy_serum main 6";
							end
						end
						if (v23.TreacherousTransmitter:IsEquippedAndReady() and (((v49:ID() == v23.TreacherousTransmitter:ID()) and IsTrinket1) or ((v50:ID() == v23.TreacherousTransmitter:ID()) and IsTrinket2)) and ((v30 < (4 - 1)) or (v46 < (1404 - (746 + 638))) or ((v46 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp()))) and (v6:BuffStack(v22.SpymastersReportBuff) <= (11 + 18))) then
							if v16(v23.TreacherousTransmitter, true) then
								return "treacherous_transmitter main 8";
							end
						end
					end
					VarGenericTrinketCondition = v33 or ((v46 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp())) or ((((v6:BuffStack(v22.SpymastersReportBuff) + (v30 / (8 - 2))) > (370 - (218 + 123))) or (v46 < (v42 + v30))) and (v30 > (1601 - (1535 + 46)))) or (v67 == (0 + 0));
					if v28.Commons.Enabled.Trinkets then
						if (v49:IsReady() and v8:IsInRange(v57) and IsTrinket1 and not v59 and not v65 and (((v67 ~= (1 + 0)) and (v50:CooldownRemains() > (580 - (306 + 254)))) or (((v67 == (1 + 0)) or (v67 == (5 - 2))) and v32) or (v46 < ((1487 - (899 + 568)) + ((14 + 6) * v17(v50:CooldownRemains() < (60 - 35))))) or VarGenericTrinketCondition)) then
							if v16(v49, true) then
								return "use_items trinket1 (" .. v49:Name() .. ") main 10";
							end
						end
						if (v50:IsReady() and v8:IsInRange(v58) and IsTrinket2 and not v60 and not v66 and (((v67 ~= (605 - (268 + 335))) and (v49:CooldownRemains() > (310 - (60 + 230)))) or ((v67 == (574 - (426 + 146))) and v32) or (v46 < (3 + 17 + ((1476 - (282 + 1174)) * v17(v49:CooldownRemains() < (836 - (569 + 242)))))) or VarGenericTrinketCondition)) then
							if v16(v50, true) then
								return "use_items trinket2 (" .. v50:Name() .. ") main 12";
							end
						end
					end
					if (v28.Commons.Enabled.Potions and (v39 or (v46 <= (86 - 56)))) then
						local v145 = v25.PotionSelected();
						if (v145 and v145:IsReady() and IsPotions) then
							v13.CastMacro(1 + 2, nil, nil, v145);
							return "potion main 14";
						end
					end
					if v6:BuffUp(v22.BearForm) then
						if (v22.ThrashBear:IsCastable() and v8:IsInRange(1029 - (706 + 318)) and v8:DebuffRefreshable(v22.ThrashBearDebuff)) then
							if v16(v22.Thrashcast) then
								return "thrash bear";
							end
						end
						if (v22.Mangle:IsCastable() and v8:IsInRange(1256 - (721 + 530)) and (v8:DebuffUp(v22.ThrashBearDebuff) or not v22.ThrashBear:IsAvailable())) then
							if v16(v22.Mangle) then
								return "Mangle bear";
							end
						end
						if (v22.Swipe:IsCastable() and v8:IsInRange(1276 - (945 + 326))) then
							if v16(v22.Swipecast) then
								return "Swipe bear";
							end
						end
						if (v22.ThrashBear:IsCastable() and v8:IsInRange(12 - 7)) then
							if v16(v22.Thrashcast) then
								return "thrash bear";
							end
						end
					...
					v34 = v6:BuffUp(v22.EclipseLunar) or v6:BuffUp(v22.EclipseSolar);
					v35 = v20(v6:BuffRemains(v22.EclipseLunar), v6:BuffRemains(v22.EclipseSolar));
					v36 = v22.LunarCalling:IsAvailable() or (v45 > ((702 - (271 + 429)) - v17((v22.UmbralIntensity:TalentRank() + v17(v22.SouloftheForest:IsAvailable())) > (1 + 0))));
					v37 = v6:BuffStack(v22.BOATArcaneBuff) + v6:BuffStack(v22.BOATNatureBuff);
					if (v22.WarriorofElune:IsCastable() and IsWarriorofElune and (v22.LunarCalling:IsAvailable() or ((v35 >= (1507 - (1408 + 92))) and (v41:CooldownRemains() > (1106 - (461 + 625)))))) then
						if v16(v22.WarriorofElune, true) then
					...
					if (v14() and (v45 > (1289 - (993 + 295))) and v22.Starfall:IsAvailable()) then
						local v146 = v92();
						if v146 then
							return v146;
						end
...
local function v94()
	...
	v13.ToggleIconFrame:AddButtonCustom("D", 1173 - (418 + 753), "Dispel", "dispel");
