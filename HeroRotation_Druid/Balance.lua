...
local function v70()
	...
	if ((v69 < (1642 - (1523 + 114))) and ((v96.ID == (0 + 0)) or (v97.ID == (0 - 0)) or (v96.Level == (1065 - (68 + 997))) or (v97.Level == (1270 - (226 + 1044))) or ((v96.SpellID > (0 - 0)) and not v96.Usable) or ((v97.SpellID > (117 - (32 + 85))) and not v97.Usable))) then
		v69 = v69 + 1 + 0;
		v21(2 + 3, function()
			v70();
		end);
	...
	local v114 = v17(v50:HasUseBuff() and (v52 ~= v23.OvinaxsMercurialEgg:ID()));
	local v115 = v17(v51:HasUseBuff() and (v53 ~= v23.OvinaxsMercurialEgg:ID())) * (959 - (892 + 65));
	v68 = (0 - 0) + v114 + v115;
end
v70();
...
local function v71(v116)
	...
	elseif (v116 == v22.Starfire) then
		...
		if (v22.SouloftheForest:IsAvailable() and v6:BuffUp(v22.EclipseLunar)) then
			local v143 = (1188 - (1069 + 118)) + ((0.2 - 0) * v46);
			if (v143 > (1.6 - 0)) then
				v143 = 1.6 + 0;
			end
			v117 = v117 * v143;
...
local function v72(v118)
	return v118:DebuffRefreshable(v22.MoonfireDebuff) and ((v118:TimeToDie() - v118:DebuffRemains(v22.MoonfireDebuff)) > (19 - 13)) and (not v22.TreantsoftheMoon:IsAvailable() or ((v46 - v22.MoonfireDebuff:AuraActiveCount()) > (3 + 3)) or ((v22.ForceofNature:CooldownRemains() > (4 - 1)) and v6:BuffDown(v22.HarmonyoftheGroveBuff)));
end
local function v73(v119)
	return (v119:DebuffRemains(v22.MoonfireDebuff) < (441 - (145 + 293))) and (not v22.TreantsoftheMoon:IsAvailable() or ((v22.ForceofNature:CooldownRemains() > (433 - (44 + 386))) and v6:BuffDown(v22.HarmonyoftheGroveBuff)));
end
local function v74(v120)
	return v120:DebuffRefreshable(v22.MoonfireDebuff) and (not v22.TreantsoftheMoon:IsAvailable() or ((v22.ForceofNature:CooldownRemains() > (1489 - (998 + 488))) and v6:BuffDown(v22.HarmonyoftheGroveBuff)));
end
local function v75(v121)
	return v121:DebuffRefreshable(v22.StellarFlareDebuff) and ((v121:TimeToDie() - v121:DebuffRemains(v22.StellarFlareDebuff)) > (3 + 4 + v46));
end
local function v76(v122)
	return v122:DebuffRefreshable(v22.StellarFlareDebuff) and ((v122:TimeToDie() - v122:DebuffRemains(v22.StellarFlareDebuff)) > (6 + 1 + v46));
end
local function v77(v123)
	return v123:DebuffRefreshable(v22.SunfireDebuff) and ((v123:TimeToDie() - v123:DebuffRemains(v22.SunfireDebuff)) > ((778 - (201 + 571)) - (v46 / (1140 - (116 + 1022)))));
end
local function v78(v124)
	return (v124:DebuffRemains(v22.SunfireDebuff) < (12 - 9)) or v124:DebuffRefreshable(v22.SunfireDebuff);
end
local function v79(v125)
	return v125:DebuffRefreshable(v22.SunfireDebuff);
end
local function v80(v126)
	return v126:NPCID() == (120072 + 84488);
end
local function v81(v127)
	return v127:CastSpellID() == (1492420 - 1083615);
end
local function v82()
...
local function v94()
	...
	v45 = v8:GetEnemiesInSplashRange(21 - 11);
	if v14() then
		v46 = (v135 and #Enemies40Yard) or EnemiesRangeOOCCount;
	else
		v46 = 1 - 0;
	end
			...
			if not v80(v5.Target) then
				if TargetinRange then
					...
					if v28.Commons.Enabled.Trinkets then
						...
						if (v23.SpymastersWeb:IsEquippedAndReady() and (((v50:ID() == v23.SpymastersWeb:ID()) and IsTrinket1) or ((v51:ID() == v23.SpymastersWeb:ID()) and IsTrinket2)) and ((v32 and ((v6:BuffStack(v22.SpymastersReportBuff) > (48 - 19)) or (v47 < v42))) or (v47 < (2 + 18)))) then
							if v16(v23.SpymastersWeb, true) then
								return "spymasters_web main 4";
							end
						end
						if (v23.ImperfectAscendancySerum:IsEquippedAndReady() and (((v50:ID() == v23.ImperfectAscendancySerum:ID()) and IsTrinket1) or ((v51:ID() == v23.ImperfectAscendancySerum:ID()) and IsTrinket2)) and (v8:DebuffRemains(v22.SunfireDebuff) > (1640 - (1373 + 263))) and ((v8:DebuffRemains(v22.MoonfireDebuff) > (1004 - (451 + 549))) or (v22.TreantsoftheMoon:IsAvailable() and ((v22.ForceofNature:CooldownRemains() < (1 + 2)) or v6:BuffUp(v22.HarmonyoftheGroveBuff)) and (v30 < (1 - 0))) or (v47 < (33 - 13)) or ((v47 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp()))) and (v6:BuffStack(v22.SpymastersReportBuff) <= (1413 - (746 + 638)))) then
							if v16(v23.ImperfectAscendancySerum, true) then
								return "imperfect_ascendancy_serum main 6";
							end
						end
						if (v23.TreacherousTransmitter:IsEquippedAndReady() and (((v50:ID() == v23.TreacherousTransmitter:ID()) and IsTrinket1) or ((v51:ID() == v23.TreacherousTransmitter:ID()) and IsTrinket2)) and ((v30 < (2 + 1)) or (v47 < (30 - 10)) or ((v47 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp()))) and (v6:BuffStack(v22.SpymastersReportBuff) <= (370 - (218 + 123)))) then
							if v16(v23.TreacherousTransmitter, true) then
								return "treacherous_transmitter main 8";
							end
						end
					end
					VarGenericTrinketCondition = v33 or ((v47 < v30) and (v6:BuffUp(v22.HarmonyoftheGroveBuff) or v22.ConvoketheSpirits:CooldownUp())) or ((((v6:BuffStack(v22.SpymastersReportBuff) + (v30 / (1587 - (1535 + 46)))) > (29 + 0)) or (v47 < (v42 + v30))) and (v30 > (3 + 17))) or (v68 == (560 - (306 + 254)));
					if v28.Commons.Enabled.Trinkets then
						if (v50:IsReady() and v8:IsInRange(v58) and IsTrinket1 and not v60 and not v66 and (((v68 ~= (1 + 0)) and (v51:CooldownRemains() > (39 - 19))) or (((v68 == (1468 - (899 + 568))) or (v68 == (2 + 1))) and v32) or (v47 < ((48 - 28) + ((623 - (268 + 335)) * v17(v51:CooldownRemains() < (315 - (60 + 230)))))) or VarGenericTrinketCondition)) then
							if v16(v50, true) then
								return "use_items trinket1 (" .. v50:Name() .. ") main 10";
							end
						end
						if (v51:IsReady() and v8:IsInRange(v59) and IsTrinket2 and not v61 and not v67 and (((v68 ~= (574 - (426 + 146))) and (v50:CooldownRemains() > (3 + 17))) or ((v68 == (1458 - (282 + 1174))) and v32) or (v47 < ((831 - (569 + 242)) + ((57 - 37) * v17(v50:CooldownRemains() < (2 + 23))))) or VarGenericTrinketCondition)) then
							if v16(v51, true) then
								return "use_items trinket2 (" .. v51:Name() .. ") main 12";
							end
						end
					end
					if (v28.Commons.Enabled.Potions and (v39 or (v47 <= (1054 - (706 + 318))))) then
					...
					if (v22.Berserking:IsCastable() and IsRacials and (v32 or v33 or (v47 < (14 + 1)))) then
						if v16(v22.Berserking, true) then
					...
					v34 = v6:BuffUp(v22.EclipseLunar) or v6:BuffUp(v22.EclipseSolar);
					v35 = v20(v6:BuffRemains(v22.EclipseLunar), v6:BuffRemains(v22.EclipseSolar));
					v36 = v22.LunarCalling:IsAvailable() or (v46 > ((1502 - (1408 + 92)) - v17((v22.UmbralIntensity:TalentRank() + v17(v22.SouloftheForest:IsAvailable())) > (1087 - (461 + 625)))));
					v37 = v6:BuffStack(v22.BOATArcaneBuff) + v6:BuffStack(v22.BOATNatureBuff);
					...
					if (v14() and (v46 > (1172 - (418 + 753))) and v22.Starfall:IsAvailable()) then
						local v147 = v93();
						if v147 then
							return v147;
						end
