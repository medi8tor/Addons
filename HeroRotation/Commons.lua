...
v21.NPCAlwaysInCombat = v21.converArrayToList({(216383 - (37 + 161)),(83134 + 131309),(229830 - (60 + 1)),(222488 + 7251),(403540 - 207659),(227442 - (1864 + 135)),(47299 + 166385),(543834 - 322490),(76699 + 58542),(162586 + 57416),(223941 - (39 + 26)),(224275 - (45 + 153)),(234576 - (457 + 95)),(460267 - 239766),(794447 - 574733),(744353 - 528527),(220494 - (485 + 263)),(214612 - (750 + 111)),(188009 + 45614),(373166 - 161932),(205528 - (189 + 121)),(232154 - (634 + 713)),(233580 - (493 + 475)),(222647 - (158 + 626)),(348608 - 137811),(11575 + 202868),(235402 - (114 + 845)),(564453 - 343949),(209796 - (179 + 870))});
v21.NPCAlwaysInCombatBossFight = v21.converArrayToList({(123846 - (827 + 51)),(49354 + 49188),(13581 + 173157),(163900 + 22716),(735599 - 539117),(812750 - 626634),(59161 + 130558),(448311 - 224532),(221298 - (1004 + 416)),(217765 - (337 + 1602))});
v21.Buggedmobs = v21.converArrayToList({(218504 - (446 + 569)),(638099 - 420608),(454597 - 235713),(218875 - (223 + 282)),(355351 - 132201),(224344 - (623 + 47)),(125784 + 98584),(225005 - (1070 + 731)),(224722 - (1257 + 147)),(423338 - 201994),(92491 + 128010),(739518 - 519772),(195226 + 26637)});
do
...
v20.ClassUpdate = function()
	v42 = v7.Persistent.Player.Class[10 - 7];
	v43 = v28[v42];
	v44 = v7.Persistent.Player.Spec[1523 - (251 + 1271)];
	v45 = v27[v44];
...
v10.IsCameraBusy = function(v151)
	return (v48 or v47) and (v49 < (GetTime() + (2 - 1)));
end;
...
v9.IncomingHeals = function(v167)
	...
	if (v169 <= (697 - (335 + 362))) then
		return 0 + 0;
	end
	local v170 = (v168 / v169) * (150 - 50);
...
v9.DebuffElapsed = function(v174, v175, v176, v177)
	...
	return ((v180 >= (0 - 0)) and v180) or (4863 - 3864);
end;
...
do
	...
	v15.CooldownWithoutGCD = function(v401)
		...
		if (v403 == (1124 - (408 + 716))) then
			return 0 - 0;
		end
		local v405 = ((v403 + v404) - GetTime()) - v10:GCDDuration();
		v405 = ((v405 > (821 - (344 + 477))) and v405) or (0 + 0);
		return v405 == (1761 - (1188 + 573));
	end;
end
...
local function v81(v223)
	if ((v223:NPCID() == (536069 - 331509)) and (v223:CastSpellID() == (398225 + 10580))) then
		return true;
	end
end
...
v21.AfflictedLogic = function(v230, v231)
	if (v12:Exists() and (v12:NPCID() == (664346 - 459573)) and v12:IsSpellInRange(v230)) then
		v4(v230, v231);
		return "afflicted";
	end
	if (v14:Exists() and (v14:NPCID() == (316539 - 111766)) and v14:IsSpellInRange(v230)) then
	...
	if v257 then
		...
		if v471 then
			for v534, v535 in v17(v471) do
				if v255[v534] then
					if (v258 == (0 + 0)) then
						v258 = math.random(1166.4 - (228 + 938), 685.9 - (332 + 353));
					end
...
local v90 = v15(1282885 - 962097);
local v91 = v15(275437 - (18 + 405));
local v92 = v15(205549 + 243012);
local v93 = v15(224049 + 219388);
local v94 = v15(659058 - 226610);
local v95 = v15(462465 - (194 + 784));
local v96 = v15(426659 - (694 + 1076));
v21.DispelCycle = function(v267, v268, v269, v270)
	local v271 = v21.DebuffList[v268];
	local function v272(v410)
		if (v268 == "Magic") then
			if (v410:DebuffUp(v90, true) and (v410:DebuffElapsed(v90, true) >= (1907.25 - (122 + 1782)))) then
				return true;
			end
			...
			if (v410:DebuffUp(v94, true) and (v410:DebuffElapsed(v94, true) >= (3 + 0))) then
				return true;
			end
			if (v410:DebuffUp(v96, true) and (v410:DebuffRemains(v96, true) <= (23 - 15))) then
				return true;
			end
...
local v102 = {[2138059 - 1695774]=(0.3 + 0),[24843 + 426381]=(585.3 - (217 + 368)),[968182 - 647720]=(0.4 + 0),[328871 + 114434]=(0.3 + 0),[456293 - (844 + 45)]=(284.3 - (242 + 42)),[854198 - 427462]=(0.3 - 0),[451295 - (132 + 1068)]=(0.3 - 0),[444060 - (214 + 1409)]=(0.3 + 0),[444908 - (497 + 1137)]=(940.3 - (9 + 931)),[442949 - (181 + 108)]=(0.3 + 0),[795277 - 472791]=(0.8 - 0),[100593 + 325715]=(0.8 + 0),[449630 - (296 + 180)]=(1403.8 - (1183 + 220)),[432574 - (1037 + 228)]=(0.8 - 0),[1246287 - 813839]=(0.8 - 0),[432084 - (527 + 207)]=(527.8 - (187 + 340)),[445300 - (1298 + 572)]=(0.8 - 0),[443603 - (144 + 26)]=(0.8 - 0),[1034175 - 590738]=(0.8 + 0),[1222604 - 774043]=(0.8 - 0),[2133492 - 1693385]=(0.8 + 0),[588723 - 154983]=(0.8 + 0),[125282 + 209466]=(202.8 - (5 + 197)),[320886 - (339 + 347)]=(0.8 - 0),[959950 - 687379]=(376.8 - (365 + 11)),[259151 + 14319]=(0.8 - 0),[645488 - 370474]=(924.8 - (837 + 87)),[746646 - 306333]=(1670.6 - (837 + 833))};
local v103 = v15(21833 + 80509);
local v104 = v15(34593 - (356 + 1031));
local v105 = v15(21732 + 26056);
local v106 = v15(8586 - (73 + 1573));
v21.CalculateWeight = function(v282)
	local v283 = 1389 - (1307 + 81);
	...
	if (v283 > (234.3 - (7 + 227))) then
		local v479 = (1 - 0) * (((v282:BuffUp(v103, true) or v282:BuffUp(v106, true) or v282:BuffUp(v104, true)) and (167.1 - (90 + 76))) or (3 - 2));
...
v21.GetLowestHealthUnit = function(v285)
	...
	for v411, v412 in v17(v285) do
		...
		if (v412:Role() == "TANK") then
			if ((not v412:ClassID() == (5 + 1)) and (v412:HealthPercentage() >= (254 - 189))) then
				v413 = v413 * (261.9 - (197 + 63));
			elseif (v412:PowerPercentage() > (5 + 15)) then
				v413 = v413 * (1.2 + 0);
			end
		end
		if (v413 < v287) then
...
v21.AoELogicWithCount = function(v333, v334, v335, v336)
	local v337 = 1275 - (155 + 1120);
	for v436, v437 in v17(v336) do
		v337 = ((v437:HealthPercentageWeighted() < v333) and (v337 + (1507 - (396 + 1110)))) or v337;
	end
...
v21.GroupBuffMissing = function(v347, v348)
	local v349 = 31 + 9;
	local v350 = {[1 + 0]=(382734 - (230 + 746)),[603 - (473 + 128)]=(381800 - (39 + 9)),[269 - (38 + 228)]=(693443 - 311694),[477 - (106 + 367)]=(33694 + 348060),[1867 - (354 + 1508)]=(1225174 - 843421),[5 + 1]=(223768 + 157964),[9 - 2]=(383000 - (334 + 910)),[903 - (92 + 803)]=(210321 + 171429),[1190 - (1035 + 146)]=(382373 - (230 + 386)),[6 + 4]=(383261 - (353 + 1157)),[1125 - (53 + 1061)]=(383381 - (1568 + 67)),[6 + 6]=(54502 + 327239),[32 - 19]=(1123225 - 741477)};
	if (v347:ID() == (16823 - 10150)) then
		v349 = 95 + 5;
	end
	...
	if ((v347:ID() == (210069 + 171679)) and (v353 < v352)) then
		return true;
	end
	return false;
end;
local v124 = v21.converArrayToList({(840741 - 455183),(1081730 - 704726),(383492 - (286 + 1690)),(44271 + 123114),(217970 + 166395)});
do
	v21.stopCastRemains = 507 - (263 + 244);
	v21.ShouldStopCastUpdate = function()
		local v442 = v10:GetEnemiesInRange(32 + 8);
		for v481, v482 in v17(v442) do
			if v124[v482:CastSpellID()] then
				v21.stopCastRemains = v482:CastRemains() - (1687.1 - (1502 + 185));
	...
	v15.IsCastable = function(v445, v446)
		return v445:IsLearned() and v445:CooldownUp(v446) and ((v21.stopCastRemains == (1527 - (629 + 898))) or (v445:ExecuteTime() < v21.stopCastRemains));
	end;
...
v21.GetCurrentEmpowerData = function(v359)
	...
	if (StageTotal and (StageTotal > (0 - 0))) then
		local v483 = 365 - (12 + 353);
		for v510 = 1912 - (1680 + 231), StageTotal do
			v361[v510] = {Start=v483,Finish=(v483 + (GetUnitEmpowerStageDuration("player", v510 - (1 + 0)) / (613 + 387)))};
			v2.Print(" Start" .. v510 .. ": " .. v361[v510].Start);
			v2.Print("Finish" .. v510 .. ": " .. v361[v510].Finish);
			v483 = v361[v510].Finish;
			if (((StartTimeMS / (2149 - (212 + 937))) + v483) <= GetTime()) then
				v360 = v510;
			end
		end
	end
...
v6:RegisterForCombatEvent(function(...)
	local v368, v369, v369, v369, v369, v369, v369, v369, v370 = select(3 + 1, ...);
	...
	for v450, v451 in v17(v127[v374:ID()]) do
		...
		elseif v375[v450] then
			for v552, v553 in v17(v126) do
				if ((v9.Nameplate[v553]:CastRemains() > (1062 - (111 + 951))) and (v9.Nameplate[v553]:CastRemains() < (1 + 0))) then
					return v450;
				end
			end
		end
...
v21.PotionSelected = function()
	...
	local v378 = {(42524 + 169741),(213896 - (595 + 1037)),(78420 + 133843)};
	local v379 = {(1282 - (1170 + 109)),(1291 - (1115 + 174)),(1015 - (85 + 929))};
	local v380 = "";
	if (v376 == "Tempered Potion") then
		for v515, v516 in ipairs(v378) do
			local v517 = v379[((v515 - (1 + 0)) % #v379) + (1868 - (1151 + 716))];
...
do
	local v381 = {Spells={v15(368072 + 9150),v15(1185462 - 857033),v15(314292 + 32543),v15(38635 + 149184),v15(91089 + 90256),v15(59081 + 97978),v15(64560 + 140051)},PetMounts={(326070 - 209268),(215854 - 128772),(206943 - 119865),(87274 - (80 + 113)),(58404 + 28676),(349548 - 262469),(15916 + 71160)}};
	v10.IsInWhitelistedVehicle = function(v452)
		local v453 = v381.Spells;
		for v486 = 1244 - (965 + 278), #v453 do
		...
		if v11:IsActive() then
			for v532 = 1730 - (1391 + 338), #v454 do
...
do
	local v383 = {v15(2750 + 75),v15(10361 + 21821),v15(264568 - 184215),v15(171284 - 80929),v15(77156 + 83296),v15(265616 - (303 + 646)),v15(392118 - (1675 + 57)),v15(92700 - 57225),v15(36453 - (338 + 639)),v15(74891 + 71664),v15(220830 - 42623),v15(232882 - (105 + 1842)),v15(626191 - 369451),v15(13124 + 296534),v15(197405 + 183896),v15(386382 + 57875)};
...
v21.HealthPotions = function()
	...
	elseif ((v10:HealthPercentage() < v23.General.HealingPotionLifePercent) and v10:AffectingCombat() and (v16.Common.HealingPotion:IsReady() or v16.Common.HealingPotion2:IsReady() or v16.Common.HealingPotion3:IsReady())) then
		v2.CastMacro(824 - (731 + 88), nil, nil, v16.Common.HealingPotion);
	...
	elseif (v23.General.AutoTargetFocusTarget and (not v12:Exists() or v12:IsDeadOrGhost()) and v9.Focus:Exists() and v9.Focus:UnitIsFriend() and v9.Focus:AffectingCombat()) then
		...
		if (v555:Exists() and v555:AffectingCombat() and v10:CanAttack(v555) and not v555:IsDeadOrGhost()) then
			v2.CastMacro(6 + 1, true);
			return "Auto asssist focus";
		end
	elseif (v23.General.AutoTab and v10:AffectingCombat() and (not v12:Exists() or v12:IsDeadOrGhost()) and (v12:NPCID() ~= (127445 + 80355))) then
		v2.TopPanelAlternative:ChangeIcon(1 + 0, 3 - 0);
		return "Auto tab to target";
	end
end;
v21.PostInitialMessage = function(v387)
	if (v387 == (807 - 548)) then
